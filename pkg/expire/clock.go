...
// Implement the Clock interface by calling the Time method
func (ex *CachedClock) Call() time.Time {
	return ex.Time()
}

// Make CachedClock implement the Clock function type
func (ex *CachedClock) ClockFunc() Clock {
	return ex.Call
}
